...
import { getAllOrders, getSingleTableNumber } from "../lib/data";
    ...
    <>
      <section className="bg-slate-100 w-4/5 my-7 p-6 rounded-md">
        <div className="flex justify-between  ">
          <h1 className="text-red-500 text-[1.5rem] font-bold">
            {" "}
            Table {tableNum}
          </h1>
          <div>
            <ReadyBtn tableNum={tableNum} orderStatus={orderStatus} />
